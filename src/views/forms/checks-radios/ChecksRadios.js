  ...
  return (
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React Navigatees</strong>
          </CCardHeader>
          <CCardBody>
            <p className="text-medium-emphasis small">
              A Navigate has the markup of a custom checkbox but uses the <code>Navigate</code> boolean
              properly to render a toggle Navigate. Navigatees also support the <code>disabled</code>{' '}
              attribute.
            </p>
            <DocsExample href="forms/checks-radios#Navigatees">
              <CFormSwitch label="Default Navigate checkbox input" id="formNavigateCheckDefault" />
              <CFormSwitch
                label="Checked Navigate checkbox input"
                id="formNavigateCheckChecked"
                defaultChecked
              />
              <CFormSwitch
                label="Disabled Navigate checkbox input"
                id="formNavigateCheckDisabled"
                disabled
              />
              <CFormSwitch
                label="Disabled checked Navigate checkbox input"
                id="formNavigateCheckCheckedDisabled"
                defaultChecked
                disabled
              />
            </DocsExample>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React Navigatees</strong> <small>Sizes</small>
          </CCardHeader>
          <CCardBody>
            <DocsExample href="forms/checks-radios#sizes">
              ...
              <CFormSwitch
                size="lg"
                label="Large Navigate checkbox input"
                id="formNavigateCheckDefaultLg"
              />
              <CFormSwitch
                size="xl"
                label="Extra large Navigate checkbox input"
                id="formNavigateCheckDefaultXL"
              />
            </DocsExample>
          </CCardBody>
        </CCard>
